...
namespace SimpleWebAppMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            // Add a test trace for OpenTelemetry
            System.Diagnostics.ActivitySource activitySource = new System.Diagnostics.ActivitySource("SimpleWebAppMVC.Home.Index");
            using (var activity = activitySource.StartActivity("TestTrace-HomeIndex"))
            {
                activity?.SetTag("custom.test", "tracing works");
                // Simulate some work
